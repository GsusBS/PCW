...
function pintarClickAzul(c, cellHeight, r, tam, fila, columna, num) { //Pinta la columna donde estaba mousove
...
function pintarNum(ctx, tam, r, cellHeight) { //Ponia los numeros por defecto del sudoku
    let num = 0;
